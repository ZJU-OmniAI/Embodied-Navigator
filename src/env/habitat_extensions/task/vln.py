...
class InstructionData:
    ...
    instruction_id: Optional[List[str]] = None
    language: Optional[List[str]] = None
    annotator_id: Optional[List[str]] = None
    edit_distance: Optional[List[str]] = None
    timed_instruction: Optional[List[str]] = None
...
class VLNEpisode(NavigationEpisode):
    ...
    optional reasoning traces, and optional shortest paths.
    ...
    reasoning: Optional[List[Any]] = attr.ib(default=None)
